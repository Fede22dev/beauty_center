...
class _GridGestureDetectorState extends State<GridGestureDetector> {
  ...
  _GridHitResult? _hitTest(Offset localPosition) {
    ...
    // FIX UX: Sostituito l'operatore ~/ con una divisione reale e .round()
    // Ora se clicchi alle 10:08 aggancia a 10:15, e non a 10:00!
    final snappedMinutes = widget.config.enableSnapping
        ? (rawMinutes / widget.config.snapToMinutes).round() *
    ...
    // Se i minuti arrotondati fanno 60 (es. 10:60), DateTime di Dart
    // è intelligente e lo trasforma in automatico nelle 11:00.
