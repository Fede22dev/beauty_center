...
class CalendarController extends ChangeNotifier {
  ...
  /// Callback interno usato dalla vista per reagire alla richiesta di scroll
  void Function(DateTime time)? onScrollToTimeCallback;

  /// Chiama questo metodo dall'esterno per far scrollare la vista all'ora desiderata
  void scrollToTime(DateTime time) {
    if (onScrollToTimeCallback != null) {
      onScrollToTimeCallback!(time);
    }
  }
