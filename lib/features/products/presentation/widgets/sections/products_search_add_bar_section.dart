...
class SectionProductsSearchAddBar extends ConsumerStatefulWidget {
  const SectionProductsSearchAddBar({
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _SectionProductsSearchAddBarState();
}

class _SectionProductsSearchAddBarState
    extends ConsumerState<SectionProductsSearchAddBar> {
