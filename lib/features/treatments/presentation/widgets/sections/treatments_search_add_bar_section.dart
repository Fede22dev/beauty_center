...
class SectionTreatmentsSearchAddBar extends ConsumerStatefulWidget {
  const SectionTreatmentsSearchAddBar({
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _SectionTreatmentsSearchAddBarState();
}

class _SectionTreatmentsSearchAddBarState
    extends ConsumerState<SectionTreatmentsSearchAddBar> {
