...
class _TreatmentsPageState extends ConsumerState<TreatmentsPage>
  ...
  static final log = AppLogger.getLogger(name: 'TreatmentsPage');
          ...
          child: AnimatedPadding(
            ...
            child: Column(
              children: [
                ...
                const Center(child: Text('Treatments1')),
                SizedBox(height: kIsWindows ? 8 : 8.h),
                const Center(child: Text('Treatments2')),
                SizedBox(height: kIsWindows ? 8 : 8.h),
                const Center(child: Text('Treatments3')),
                SizedBox(
