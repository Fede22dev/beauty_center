...
class _SuppliersPageState extends ConsumerState<SuppliersPage>
  ...
  static final log = AppLogger.getLogger(name: 'SuppliersPage');
          ...
          child: AnimatedPadding(
            ...
            child: Column(
              children: [
                ...
                const Center(child: Text('SuppliersPage1')),
                SizedBox(height: kIsWindows ? 8 : 8.h),
                const Center(child: Text('SuppliersPage2')),
                SizedBox(height: kIsWindows ? 8 : 8.h),
                const Center(child: Text('SuppliersPage3')),
                SizedBox(
